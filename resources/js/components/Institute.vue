<template>
	...
	<div>
		<a class="button is-link is-rounded" @click="openModal()">Add Institute</a> <br> <br>
		...
		<div id="modal"class="modal is-active" v-if="showModal">
			...
			<div class="modal-card">
				<header class="modal-card-head">
					<p class="modal-card-title">Add Institute</p>
					<button class="delete" aria-label="close" @click="closeModal()"></button>
				</header>
				<section class="modal-card-body">

					<form method="POST" action="/institutes" @submit="formSubmit">
